...
class Challenge extends Component {
  ...
  formatCompletedChallenges(completedChallenges) {
    ...
    this.setState({ completedChallenges: completedChallengesArr, isCompletedMounted: true });
  }
  ...
  formatActiveChallenges(activeChallenges) {
    ...
    this.setState({ activeChallenges: activeChallengesArr, isActiveMounted: true });
